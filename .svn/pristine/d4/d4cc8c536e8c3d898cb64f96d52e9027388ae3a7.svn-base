...
<jsp:body>
	<div class="row">
		<div class="col-sm-10 col-md-8 col-lg-6">
			...
			<form method="get" action = "${pageContext.request.contextPath}/ServletPrecedentAudit">
			
			</form>
			<form method="post" action = "${pageContext.request.contextPath}/ServletPrecedentAudit">
